...
@pytest.mark.tcid("PY-152")
def test_payout_wallet_amount_with_kopecks():
    """Выплата на кошелёк — сумма с копейками (1050 = 10.50 руб). Ожидается 201 и amount=1050 в ответе."""
    body = {
        **_BASE,
