...
@pytest.mark.tcid("PY-150")
def test_payout_mobile_amount_with_kopecks():
    """Выплата на мобильный — сумма с копейками (1050 = 10.50 руб). Ожидается 201 и amount=1050 в ответе."""
    body = {
        **_BASE,
